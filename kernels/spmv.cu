...
void launch_spmv_coo_kernel (int n_blocks, int n_threads, int *rowidx, int *colidx, float *values, float *v, float *w, long long nnz) {
...
//
//	cudaMemcpy (v_out, v_out_d, n_elements * sizeof(T), cudaMemcpyDeviceToHost);
//
